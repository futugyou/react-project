...
export const getHandleIntersectionPoint = (shape: SpeechBubbleShape) => {
    const { w, h, handles } = shape.props
    const handleInShapeSpace = new Vec(handles.handle.x * w, handles.handle.y * h)
...
const intersectLineSegmentLineSegment = (a1: VecLike, a2: VecLike, b1: VecLike, b2: VecLike) => {
    const ABx = a1.x - b1.x
    const ABy = a1.y - b1.y
    const BVx = b2.x - b1.x
    const BVy = b2.y - b1.y
 ...
 */
const mapRange = (a1: number, b1: number, a2: number, b2: number, s: number) => {
