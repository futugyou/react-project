...
import {
  PlayingCardTool,
  ConfigPlayingCardTool,
  PlayingCardToolBar,
} from '../Component/PlayingCard/PlayingCardTool'
import {
  EditableShapeTool,
  ConfigEditableTool,
  EditableToolBar,
} from '../Component/Editable/EditableShapeTool'
import { CardShapeTool, ConfigCardTool, CardToolBar } from '../Component/Card/CardShapeTool'
import {
  ScreenshotTool,
  ConfigScreenshotTool,
  ScreenshotToolBar,
} from '../Component/Screenshot/ScreenshotTool'
...
const Toolbar = () => {
  return (
    <CustomToolbar>
      {CustomToolBars.map((ToolBarComponent, index) => (
        <ToolBarComponent key={index} />
      ))}
    </CustomToolbar>
  )
}
...
export const CustomeShapes: TLAnyShapeUtilConstructor[] = [
  CardShapeUtil,
  HtmlShapeUtil,
  EditableShapeUtil,
  PlayingCardUtil,
