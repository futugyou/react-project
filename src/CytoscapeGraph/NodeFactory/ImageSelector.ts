...
const serviceIconMap = {
  ...
  'VPC-subnet-public_light-bg-warning': 'AWS::EC2::Subnet-public-status-warning',
  ...
  'Amazon-RDS_Amazon-RDS_instance_light-bg': 'AWS::RDS::DBInstance-status-available',
  'Amazon-RDS_Amazon-RDS_instance_light-bg-warning': 'AWS::RDS::DBInstance-status-warning',
  'Amazon-RDS_Amazon-RDS_instance_light-bg-error': 'AWS::RDS::DBInstance-status-negative',
  ...
  'Amazon-Neptune_light-bg-warning': 'AWS::RDS::DBInstance-neptune-status-warning',
  'Amazon-Neptune_light-bg-error': 'AWS::RDS::DBInstance-neptune-status-negative',
  'Amazon-RDS_MySQL_instance_light-bg-menu': 'AWS::RDS::DBInstance-mysql',
  'Amazon-RDS_MySQL_instance_light-bg': 'AWS::RDS::DBInstance-mysql-status-available',
  'Amazon-RDS_MySQL_instance_light-bg-warning': 'AWS::RDS::DBInstance-mysql-status-warning',
  'Amazon-RDS_MySQL_instance_light-bg-error': 'AWS::RDS::DBInstance-mysql-status-negative',
  'Amazon-RDS_PostgreSQL_instance_light-bg-menu': 'AWS::RDS::DBInstance-postgres',
  'Amazon-RDS_PostgreSQL_instance_light-bg': 'AWS::RDS::DBInstance-postgres-status-available',
  'Amazon-RDS_PostgreSQL_instance_light-bg-warning': 'AWS::RDS::DBInstance-postgres-status-warning',
  'Amazon-RDS_PostgreSQL_instance_light-bg-error': 'AWS::RDS::DBInstance-postgres-status-negative',
  'Amazon-RDS_MariaDB_instance_light-bg-menu': 'AWS::RDS::DBInstance-mariadb',
  'Amazon-RDS_MariaDB_instance_light-bg': 'AWS::RDS::DBInstance-mariadb-status-available',
  'Amazon-RDS_MariaDB_instance_light-bg-warning': 'AWS::RDS::DBInstance-mariadb-status-warning',
  'Amazon-RDS_MariaDB_instance_light-bg-error': 'AWS::RDS::DBInstance-mariadb-status-negative',
  'Amazon-RDS_SQL-Server_instance_light-bg-menu': 'AWS::RDS::DBInstance-sqlserver-ex',
  'Amazon-RDS_SQL-Server_instance_light-bg': 'AWS::RDS::DBInstance-sqlserver-ex-status-available',
  ...
  'Amazon-RDS_Amazon-Aurora_instance_light-bg-menu': 'AWS::RDS::DBInstance-aurora',
  'Amazon-RDS_Amazon-Aurora_instance_light-bg': 'AWS::RDS::DBInstance-aurora-status-available',
  'Amazon-RDS_Amazon-Aurora_instance_light-bg-warning':
    'AWS::RDS::DBInstance-aurora-status-warning',
  'Amazon-RDS_Amazon-Aurora_instance_light-bg-error': 'AWS::RDS::DBInstance-aurora-status-negative',
  ...
  'Amazon-RDS_Amazon-Aurora_instance_mysql_light-bg-menu': 'AWS::RDS::DBInstance-aurora-mysql',
  ...
  'AWS-Identity-and-Access-Management-IAM_Permissions_light-bg': 'AWS::IAM::AWSPolicyStatement',
  ...
  'Amazon-Elastic-Block-Store-EBS_Volume_light-bg': 'AWS::EC2::Volume-status-available',
  'Amazon-Elastic-Block-Store-EBS_Volume_light-bg-warning': 'AWS::EC2::Volume-status-warning',
  'Amazon-Elastic-Block-Store-EBS_Volume_light-bg-error': 'AWS::EC2::Volume-status-negative',
  ...
  'Amazon-Elastic-Container-Service-warning': 'AWS::ECS::Cluster-status-warning',
  ...
  'AWS-Identity-and-Access-Management-IAM_Data-Encryption-Key_light-bg': 'AWS::KMS::Key',
  ...
  'Amazon-Elastic-Kubernetes-Service-error': 'AWS::EKS::Cluster-status-negative',
  'Amazon-Elastic-Kubernetes-Service-warning': 'AWS::EKS::Cluster-status-warning',
  ...
  'Amazon-VPN_Connection_light-bg-warning': 'AWS::EC2::VPNConnection-status-warning',
  'Amazon-VPN_Connection_light-bg-error': 'AWS::EC2::VPNConnection-status-negative',
  'Amazon-VPN_Connection_Route_light-bg-menu': 'AWS::EC2::VPNConnectionRoute',
  'Amazon-VPN_Connection_Route_light-bg': 'AWS::EC2::VPNConnectionRoute-status-available',
  'Amazon-VPN_Connection_Route_light-bg-warning': 'AWS::EC2::VPNConnectionRoute-status-warning',
  'Amazon-VPN_Connection_Route_light-bg-error': 'AWS::EC2::VPNConnectionRoute-status-negative',
  ...
  'Amazon-VPC_Customer_Gateway_light-bg': 'AWS::EC2::CustomerGateway-status-available',
  'Amazon-VPC_Customer_Gateway_light-bg-warning': 'AWS::EC2::CustomerGateway-status-warning',
  'Amazon-VPC_Customer_Gateway_light-bg-error': 'AWS::EC2::CustomerGateway-status-negative',
...
export const fetchImage = (type: string, state?: any) => {
  let image
  if (state && type) {
...
const buildURL = (image: string) => {
  return `/icons/${image}.svg`
}

export const fetchLogo = (transparent: boolean) => {
  return transparent
    ? `/icons/${icons.get('logo-transparent')}.svg`
    : `/icons/${icons.get('logo')}.svg`
}

export const getAccountColour = (account: string) => {
  return randomColor({
    luminosity: 'dark',
    format: 'rgba',
    alpha: 0.5,
...
export const getRegionColour = (region: string) => {
  return randomColor({
    luminosity: 'dark',
    format: 'rgba',
    alpha: 0.5,
...
export const getAZColour = (az: string) => {
  return randomColor({
    luminosity: 'dark',
    format: 'rgba',
    alpha: 0.5,
