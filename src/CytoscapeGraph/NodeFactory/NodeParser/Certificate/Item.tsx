...
export const Item = (configuration: any) => {
  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        <ValueWithLabel label="domainName">{parsedConfig.domainName}</ValueWithLabel>
        <ValueWithLabel label="issuedAt">{parsedConfig.issuedAt}</ValueWithLabel>
        <ValueWithLabel label="issuer">{parsedConfig.issuer}</ValueWithLabel>
        <ValueWithLabel label="keyAlgorithm">{parsedConfig.keyAlgorithm}</ValueWithLabel>
        <ValueWithLabel label="signatureAlgorithm">
          {parsedConfig.signatureAlgorithm}
        </ValueWithLabel>
        <ValueWithLabel label="subject">{parsedConfig.subject}</ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
