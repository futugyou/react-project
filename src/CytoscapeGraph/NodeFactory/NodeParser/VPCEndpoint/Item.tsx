  ...
  return (
    <ColumnLayout columns={1} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="vpcEndpointId">{parsedConfig.vpcEndpointId}</ValueWithLabel>
        <ValueWithLabel label="vpcEndpointType">{parsedConfig.vpcEndpointType}</ValueWithLabel>
        <ValueWithLabel label="serviceName">{parsedConfig.serviceName}</ValueWithLabel>
        <ValueWithLabel label="ipAddressType">{parsedConfig.ipAddressType}</ValueWithLabel>
        <ValueWithLabel label="networkInterfaceIds">
          <ul>{networkInterfaceIds}</ul>
        </ValueWithLabel>
