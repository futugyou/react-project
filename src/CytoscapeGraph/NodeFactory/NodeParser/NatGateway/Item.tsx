  ...
  return (
    <ColumnLayout columns={1} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="subnetId">{parsedConfig.subnetId}</ValueWithLabel>
        <ValueWithLabel label="natGatewayId">{parsedConfig.natGatewayId}</ValueWithLabel>
        <ValueWithLabel label="connectivityType">{parsedConfig.connectivityType}</ValueWithLabel>
