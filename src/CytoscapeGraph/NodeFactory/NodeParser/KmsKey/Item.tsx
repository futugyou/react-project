  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="keyId">{parsedConfig.keyId}</ValueWithLabel>
        <ValueWithLabel label="keyManager">{parsedConfig.keyManager}</ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
        <ValueWithLabel label="keySpec">{parsedConfig.keySpec}</ValueWithLabel>
        <ValueWithLabel label="keyUsage">{parsedConfig.keyUsage}</ValueWithLabel>
