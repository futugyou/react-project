...
export const Item = (configuration: any) => {
  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        <ValueWithLabel label="AccessPointId">{parsedConfig.AccessPointId}</ValueWithLabel>
        <ValueWithLabel label="Arn">{parsedConfig.Arn}</ValueWithLabel>
        <ValueWithLabel label="ClientToken">{parsedConfig.ClientToken}</ValueWithLabel>
        <ValueWithLabel label="FileSystemId">{parsedConfig.FileSystemId}</ValueWithLabel>
        <ValueWithLabel label="RootDirectory">{parsedConfig.RootDirectory?.Path}</ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
