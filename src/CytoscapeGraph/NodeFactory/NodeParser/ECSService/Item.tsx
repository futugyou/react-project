...
export const Item = (configuration: any) => {
  ...
  return (
    <ColumnLayout columns={1} variant="text-grid">
      <SpaceBetween size="l">
        <ValueWithLabel label="Name">{parsedConfig.Name}</ValueWithLabel>
        <ValueWithLabel label="Cluster">{parsedConfig.Cluster}</ValueWithLabel>
        <ValueWithLabel label="TaskDefinition">{parsedConfig.TaskDefinition}</ValueWithLabel>
