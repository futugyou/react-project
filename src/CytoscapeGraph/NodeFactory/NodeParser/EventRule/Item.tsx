  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="EventBusName">{parsedConfig.EventBusName}</ValueWithLabel>
        <ValueWithLabel label="Id">{parsedConfig.Id}</ValueWithLabel>
      ...
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="State">{parsedConfig.State}</ValueWithLabel>
