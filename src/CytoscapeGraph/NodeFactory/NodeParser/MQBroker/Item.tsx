...
const Item = (configuration: any) => {
  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        <ValueWithLabel label="BrokerName">{parsedConfig.BrokerName}</ValueWithLabel>
        <ValueWithLabel label="DeploymentMode">{parsedConfig.DeploymentMode}</ValueWithLabel>
        <ValueWithLabel label="EngineType">{parsedConfig.EngineType}</ValueWithLabel>
        <ValueWithLabel label="HostInstanceType">{parsedConfig.HostInstanceType}</ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
