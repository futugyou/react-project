...
export const Item = (configuration: any) => {
  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        <ValueWithLabel label="functionArn">{parsedConfig.functionArn}</ValueWithLabel>
        <ValueWithLabel label="functionName">{parsedConfig.functionName}</ValueWithLabel>
        <ValueWithLabel label="handler">{parsedConfig.handler}</ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
        <ValueWithLabel label="role">{parsedConfig.role}</ValueWithLabel>
