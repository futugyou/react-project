  ...
  return (
    <ColumnLayout columns={2} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="Instance class">{parsedConfig.dBInstanceClass}</ValueWithLabel>
        <ValueWithLabel label="Database name">{parsedConfig.dBName}</ValueWithLabel>
        <ValueWithLabel label="Backup window">{parsedConfig.preferredBackupWindow}</ValueWithLabel>
        <ValueWithLabel label="Maintainance window">
          {`${parsedConfig.preferredMaintenanceWindow}`}
        </ValueWithLabel>
      </SpaceBetween>
      <SpaceBetween size="l">
        <ValueWithLabel label="Certificate">{parsedConfig.cACertificateIdentifier}</ValueWithLabel>
