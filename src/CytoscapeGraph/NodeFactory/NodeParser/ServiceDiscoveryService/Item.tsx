  ...
  return (
    <ColumnLayout columns={1} variant="text-grid">
      <SpaceBetween size="l">
        ...
        <ValueWithLabel label="NamespaceId">{parsedConfig.NamespaceId}</ValueWithLabel>
        <ValueWithLabel label="Type">{parsedConfig.Type}</ValueWithLabel>
        <ValueWithLabel label="Description">{parsedConfig.Description}</ValueWithLabel>
        <ValueWithLabel label="NamespaceId">{parsedConfig.DnsConfig?.NamespaceId}</ValueWithLabel>
