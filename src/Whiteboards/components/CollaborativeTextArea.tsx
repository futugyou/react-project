...
const CollaborativeTextArea = (props: ICollaborativeTextAreaProps) => {
    const sharedStringHelper = new SharedStringHelper(props.sharedString)
     ...
     */
    const handleChange = (ev: FormEvent<HTMLTextAreaElement>) => {
