...
const DateRangePickerEx = (prop: DateRangePickerItem) => {
  ...
  let initData = prop.InitData ?? {
    type: 'absolute',
    startDate: prop.DateOnly
      ? moment(prop.StartDate).format('yyyy-MM-DD')
      : prop.StartDate.toISOString(),
