...
const EdgeStyle = (props: EdgeStyleProps) => {
  ...
  const [startMarker, setStartMarker] = useState<EdgeMarker | undefined>(
    getEdgeMarker(props.selectedEdge.markerStart),
  )
  const [endMarker, setEndMarker] = useState<EdgeMarker | undefined>(
    getEdgeMarker(props.selectedEdge.markerEnd),
  )
  ...
  const onColorChange = (color: ColorResult) => {
    ...
    if (colorMark == 'lable') {
      if (edgeType == 'default') {
        setSelectedEdge({
          ...selectedEdge,
          labelStyle: { ...selectedEdge.labelStyle, fill: color.hex, color: color.hex },
        })
      } else {
        setSelectedEdge({
          ...selectedEdge,
          labelStyle: { ...selectedEdge.labelStyle, color: color.hex },
        })
      }
    }
  }
      ...
      <div className={styles.groupContainer}>
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={`${styles.groupLayerItem} ${edgeType != 'floating' ? styles.selected : ''}`}
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={`${styles.groupLayerItem} ${pathType == 'bezier' ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${pathType == 'smoothstep' ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${pathType == 'straight' ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${pathType == 'step' ? styles.selected : ''}`}
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={`${styles.groupLayerItem} ${!selectedEdge.style?.strokeDasharray && !selectedEdge.animated ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${selectedEdge.animated ? styles.selected : ''}`}
            ...
            <div className={`${styles.groupLayerItem} ${styles.color}`}>
              <div
                onClick={() => onColorClick('line')}
                style={{
                  width: '100%',
                  height: '50%',
                  backgroundColor: selectedEdge.style?.stroke,
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={`${styles.groupLayerItem} ${startMarker == undefined ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${startMarker?.type == 'arrowclosed' ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${startMarker?.type == 'arrow' ? styles.selected : ''}`}
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={`${styles.groupLayerItem} ${endMarker == undefined ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${endMarker?.type == 'arrowclosed' ? styles.selected : ''}`}
            ...
            <div
              className={`${styles.groupLayerItem} ${endMarker?.type == 'arrow' ? styles.selected : ''}`}
            ...
            <div className={`${styles.groupLayerItem} ${styles.color}`}>
              <div
                onClick={() => onColorClick('end')}
                style={{
                  width: '100%',
                  height: '50%',
                  backgroundColor: endMarker?.color,
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            ...
            <div
              className={`${styles.groupLayerItem} ${styles.color}`}
              style={{ width: '52px', height: '52px' }}
            >
              <div
                onClick={() => onColorClick('lable')}
                style={{
                  width: '100%',
                  height: '50%',
