        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'diamond')}
            >
            ...
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'ellipse')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
                <title>ellipse</title>
            ...
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'parallelogram')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
        ...
        <div className={styles.groupLayerContainer}>
          ...
          <div className={styles.groupLayer}>
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'rect')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
                <title>rect</title>
            ...
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'radiusrect')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
            ...
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'db')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
                <title>database</title>
                <path
                  d="M0,5L 0,35A 20 5 0 1 0 40 35L 40,5 A 20 5 0 1 1 0 5A 20 5 0 1 1 40 5 A 20 5 0 1 1 0 5 z"
                  fill="#ff6700"
                  stroke="#fff"
                ></path>
              </svg>
            ...
            <div
              className={styles.groupLayerItem}
              draggable
              onDragStart={(event) => onDragStart(event, 'shape', 'bus')}
            >
              <svg width="40" height="40" xmlns="http://wwww.w3.org/2000/svg">
                <title>service bus</title>
                <path
                  d="M 35,0L 5,0A 5 20 0 1 0 5 40L 35,40A 5 20 0 1 1 35,0A 5 20 0 1 1 35,40A 5 20 0 1 1 35,0 z"
                  fill="#ff6700"
                  stroke="#fff"
                ></path>
              </svg>
