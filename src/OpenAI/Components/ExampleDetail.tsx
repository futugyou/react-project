      ...
      <div className="detail-header">
        ...
        {authService.isAuthenticated() && (
          <div className="detail-header-link">
            <Link onFollow={onEidtClick}>Edit</Link>
          </div>
        )}
        <div className="detail-header-link">
      ...
      <div className="detail-body">
        <div className="detail-body-left">
          ...
          <div className="detail-prompt">
            <div className="detail-prompt-header">Prompt</div>
            <div className="detail-prompt-content">{props.data.prompt}</div>
          </div>
          <div className="detail-response">
            <div className="detail-response-header">Sample response</div>
            <div className="detail-response-content">{props.data.sample_response}</div>
          </div>
        </div>
