...
const ChatPanel = (props: any) => {
  ...
  const chatExchangeClassName = props.disabled
    ? 'chat-pg-exchange playground-disabled'
    : 'chat-pg-exchange'
    ...
    <>
      <div className="chat-pg-instructions">
        ...
        <div className="text-input-header-wrapper">
          <Textarea
            onChange={(e) => props.onInstructionChange(e.detail.value)}
