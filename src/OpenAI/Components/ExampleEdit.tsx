...
const ExampleEdit = (props: any) => {
  ...
  return (
    <>
      {showError && (
        <div className="alert alert-danger check-message" role="alert">
          No change for exmaple data !
        </div>
      )}
      {showSuccess && (
        <div className="alert alert-success check-message" role="alert">
        ...
        <div className="edit-body">
          <div className="edit-body-left">
            <div className="edit-item">
              <div className="edit-item-header">Description</div>
              <div className="edit-item-content">
                <Textarea
                  onChange={(e) => handleDescChanged(e.detail.value)}
            ...
            <div className="edit-item">
              <div className="edit-item-header">Prompt</div>
              <div className="edit-item-content">
                <Textarea
                  onChange={(e) => handlePromptChange(e.detail.value)}
            ...
            <div className="edit-item" style={{ marginBottom: '0px' }}>
              <div className="edit-item-header">Sample response</div>
              <div className="edit-item-content">
                <Textarea
                  onChange={(e) => handleResponseChange(e.detail.value)}
                  value={props.data.sample_response}
                  rows={10}
                />
              </div>
            </div>
          ...
          <div className="edit-body-right">
            ...
            <div className="edit-setting-edits">
              ...
              <div className="edit-setting-container">
                <div className="edit-setting-text">
                  <MaxTokens
                    max_tokens={props.data.max_tokens}
              ...
              <div className="edit-setting-container">
                <div className="edit-setting-text">
                  <Frequency
                    frequency_penalty={props.data.frequency_penalty}
              ...
              <div className="edit-setting-container">
                <div className="edit-setting-text">
                  <Presence
                    presence_penalty={props.data.frequency_penalty}
