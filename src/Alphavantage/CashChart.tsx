...
const DataTypes = [
  ...
  { label: 'Cashflow From Financing', value: 'CashflowFromFinancing' },
  {
    ...
    value: 'ProceedsFromRepaymentsOfShortTermDebt',
  },
  ...
  {
    label: 'Payments For Repurchase Of Preferred Stock',
    value: 'PaymentsForRepurchaseOfPreferredStock',
  },
  ...
  { label: 'Proceeds From Issuance Of Common Stock', value: 'ProceedsFromIssuanceOfCommonStock' },
  {
    ...
    value: 'ProceedsFromIssuanceOfLongTermDebtAndCapitalSecuritiesNet',
  },
  {
    label: 'Proceeds From Issuance Of Preferred Stock',
    value: 'ProceedsFromIssuanceOfPreferredStock',
  },
